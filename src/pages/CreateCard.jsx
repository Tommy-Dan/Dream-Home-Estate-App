...
// destructuring
   const { type, name, bedrooms, bathrooms, parking, 
           furnished, address, description, offer, 
    ...
    {/* Sell or Rent */}
        ...
        {/* Name input */}
            ...
            <input type="text" id="name" value={name} onChange={onChange}
              placeholder="Full Name" maxLength="32" minLength="10" required
        ...
        {/* Rooms and Washrooms */}
            <div className="flex space-x-6 mb-6">
                ...
                <div>
                    <p className='text-lg font-semibold'>Washrooms</p>
        ...
        {/* Offer section */}
            <p className='ml-2 text-lg font-semibold'>Offers?</p>
                ...
                <div className="">
                    ...
                    <div className="flex w-full justify-center items-center space-x-6">
                        <input type="number" id="regularPrice" value={regularPrice}
                           onChange={onChange} min="2000" max="1000000" required 
                           className='w-full px-4 py-2 text-xl text-gray-700 bg-white
                ...
                <div className="">
                    ...
                    <div className="flex w-full justify-center items-center space-x-6">
                        <input type="number" id="discountedPrice" value={discountedPrice}
                           onChange={onChange} min="2000" max="1000000" required={offer}
                           className='w-full px-4 py-2 text-xl text-gray-700 bg-white
                                      border border-gray-300 rounded transition
                                      duration-150 ease-in-out focus:text-gray-700 
                                      focus:bg-white focus:border-slate-600 text-center'
